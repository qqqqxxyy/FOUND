...
def train_model(
    ...
    for epoch in range(config.training["nb_epochs"]):
        ...
        for i, data in tbar:
            ...
            #preds_mask_bs.shape: 50,28,28
            # Compute the loss $L^s$
...
if __name__ == "__main__":
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = config.training['gen_device']
    # ------------------------------------
